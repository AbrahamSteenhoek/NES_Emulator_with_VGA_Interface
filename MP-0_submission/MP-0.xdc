...
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {PAD[1]}];  # "JC1_N"  "Virtual Switch 7"
set_property PACKAGE_PIN AB7 [get_ports {PAD[0]}];  # "JC1_P"  "Virtual Switch 6"
set_property PACKAGE_PIN AA4 [get_ports {PAD[3]}];  # "JC2_N"  "Virtual Switch 5"
set_property PACKAGE_PIN Y4  [get_ports {PAD[2]}];  # "JC2_P"  "Virtual Switch 4"
#set_property PACKAGE_PIN T6  [get_ports {PAD[3]}];  # "JC3_N"  "Virtual Switch 3"  
set_property PACKAGE_PIN R6  [get_ports {PAD[4]}];  # "JC3_P"  "Virtual Switch 2"
#set_property PACKAGE_PIN U4  [get_ports {PAD[0]}];  # "JC4_N"  "Virtual Switch 1"
#set_property PACKAGE_PIN T4  [get_ports {v_sw[0]}];  # "JC4_P"  "Virtual Switch 0"

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W7 [get_ports {v_sw[2]}];  # "JD1_N"   "Virtual Button Up"
set_property PACKAGE_PIN V7 [get_ports {v_sw[3]}];  # "JD1_P"   "Virtual Button Down"
set_property PACKAGE_PIN V4 [get_ports {v_sw[0]}];  # "JD2_N"   "Virtual Button Right"
set_property PACKAGE_PIN V5 [get_ports {v_sw[1]}];  # "JD2_P"   "Virtual Button Left"
set_property PACKAGE_PIN W5 [get_ports {v_sw[6]}];  # "JD3_N"   "Virtual Button Center"
set_property PACKAGE_PIN W6 [get_ports {v_sw[7]}];  # "JD3_P"
set_property PACKAGE_PIN U5 [get_ports {v_sw[4]}];  # "JD4_N"
set_property PACKAGE_PIN U6 [get_ports {v_sw[5]}];  # "JD4_P"
...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {VGA_out[8]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {VGA_out[9]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {VGA_out[10]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {VGA_out[11]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {VGA_out[4]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {VGA_out[5]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {VGA_out[6]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {VGA_out[7]}];  # "VGA-G4"
set_property PACKAGE_PIN AA19 [get_ports {VGA_HS}];  # "VGA-HS"
set_property PACKAGE_PIN V20  [get_ports {VGA_out[0]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {VGA_out[1]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {VGA_out[2]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {VGA_out[3]}];  # "VGA-R4"
